...
async (conn, mek, m, { from, reply }) => {
    const githubRepoURL = 'https://github.com/PASIYAv12/PASIYA-MDhttps://github.com/PASIYAv12/PASIYA-MD';
...
> ${config.DESCRIPTION}`;
        ...
        await conn.sendMessage(from, {
            image: { url: config.MENU_IMAGE_URL || 'https://files.catbox.moe/wbrnn4.jpg' },
            ...
            contextInfo: { 
                ...
                forwardedNewsletterMessageInfo: {
                    ...
                    newsletterName: config.OWNER_NAME || 'pasidu sampath',
                    serverMessageId: 143
                }
            }
        }, { quoted: mek });
